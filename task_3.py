...
# Критерії оцінювання:
# Коректність роботи функції: функція має правильно обробляти різні формати номерів, враховуючи наявність або
...
def normalize_phone(phone_number):
    """The function remove any symbols and return clean phone numbers in right format"""
...
ready_to_use_numbers = [normalize_phone(number) for number in raw_numbers]

print("Нормалізовані номери телефонів для SMS-розсилки:", ready_to_use_numbers)
